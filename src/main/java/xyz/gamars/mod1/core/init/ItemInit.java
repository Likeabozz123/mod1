...
public class ItemInit {
    ...
    public static final RegistryObject<Item> ITEM_2 = ITEMS.register("item_2", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> ITEM_3 = ITEMS.register("item_3", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
