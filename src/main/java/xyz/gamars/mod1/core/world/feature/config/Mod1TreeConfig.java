...
public class Mod1TreeConfig implements IFeatureConfig {

    public static final Codec<Mod1TreeConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
        ...
        })).apply(codecRecorder, Mod1TreeConfig::new);
    });
    ...
    Mod1TreeConfig(BlockStateProvider trunkProvider, BlockStateProvider leavesProvider, BlockStateProvider groundReplacementProvider, BlockStateProvider diskProvider, int minHeight, int maxHeight, int diskRadius, List<BlockState> whitelist) {
    ...
    public static class Builder {
        ...
        public Builder copy(Mod1TreeConfig config) {
        ...
        public Mod1TreeConfig build() {
            return new Mod1TreeConfig(this.trunkProvider, this.leavesProvider, this.groundReplacementProvider, this.diskProvider, this.minHeight, this.maxPossibleHeight, this.diskRadius, this.whitelist.stream().map(Block::defaultBlockState).collect(Collectors.toList()));
        }
    }
}